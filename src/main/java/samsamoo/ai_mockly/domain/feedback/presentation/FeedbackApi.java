...
public interface FeedbackApi {
    ...
    ResponseEntity<SuccessResponse<Message>> saveFeedback(
            @Parameter(description = "정보를 불러오고 싶은 회원의 Access Token을 입력하시오.", required = true) @Valid @LoginMember Member member,
            @Parameter(description = "Schemas의 ReedbackSaveReq를 참고", required = true) @RequestBody FeedbackSaveReq feedbackSaveReq);
}
